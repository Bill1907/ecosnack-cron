...
#### 톤과 스타일
- 친근한 존댓말: "~예요", "~입니다", "~해보세요"
- 일상 비유 활용: "마치 ~처럼", "쉽게 말해 ~"
- 공감 표현: "걱정되시죠?", "좋은 소식이에요", "부담이 되실 수 있어요"
- 독자에게 말 걸기: "~하시는 분들", "여러분", "우리"
...
#### 톤과 스타일
- 딱딱한 문어체: "~함", "~이다", "~로 판단됨", "~할 것으로 보임"
- 무서운 표현: "폭락", "붕괴", "위기" (→ "조정", "어려움", "주의가 필요" 등으로 완화)
- 짧고 건조한 설명: 한 문장으로 끝내지 마세요
