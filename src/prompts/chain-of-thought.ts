...
| 필드 | 권장 길이 | 문장 수 | 필수 포함 |
|------|----------|--------|----------|
| headline_summary | 150-200자 | 4-5문장 | - |
| so_what.main_point | 200-300자 | 5-7문장 | 비유/예시 1개+ |
| so_what.market_signal | 120-180자 | 3-4문장 | 영향 경로 설명 |
| impact_analysis 각 summary | 150-220자 | 4-5문장 | 실생활 예시 1개+ |
| related_context.background | 150-220자 | 4-5문장 | 역사적 맥락 |
| related_context.what_to_watch | 100-150자 | 3-4문장 | 구체적 날짜/시점 |

**충분히 길게 설명해주세요!** 짧고 건조한 설명보다 친절하고 상세한 설명이 독자에게 훨씬 도움이 됩니다.

### 필수 체크리스트 (작성 전 확인!)
- [ ] 비유/예시를 최소 2개 이상 포함했는가?
- [ ] "예를 들어", "마치~처럼" 표현을 사용했는가?
- [ ] 구체적 수치나 기간(예: 3개월, 5%)을 명시했는가?
- [ ] 독자에게 말 걸듯이 작성했는가? ("~하시는 분들", "~해보세요")
